...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("انتخاب کاربران");
        ...
        jLabel3.setText("کلمه عبور");

        jLabel2.setText("نام کاربری");

        jLabel4.setText("شماره ");

        txt_id.setEditable(false);

        jLabel5.setText("نوع کاربر");
        ...
        cmd_update.setText("به روزرسانی");
